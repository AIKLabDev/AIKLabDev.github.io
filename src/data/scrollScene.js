...
export const sceneConfig = {
  ...
  snap: {
     ...
     * 그 관성이 우리 애니메이션과 충돌하면 중단 -> 즉시 다음 명령 -> 중단이
     * 연쇄되어 섹션이 8,7,6 으로 주르륵 넘어간다. 재진입 직후 잠깐 잠가 흡수한다.
     */
    reentryMs: 350,
    /**
     * 관성을 잡아 세울 때의 이동 시간(ms).
     * 일반 전환(duration)보다 짧게 잡는다 — 이건 연출이 아니라 "붙잡기"이고,
     * 그동안 관성과 스크롤 위치를 다투므로 길수록 어색하다.
     */
    captureDuration: 400,
  },
}
