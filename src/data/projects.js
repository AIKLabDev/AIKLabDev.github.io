export const projects = [
  ...
  },
  {
    ...
    media: {
      kind: 'loop',
      src: '/media/palletizing.webm',
      poster: '/media/palletizing.jpg',
      caption: '협동로봇이 3D 비전으로 인식한 위치에 맞춰 박스를 팔레트에 적재',
    },
  },
  {
    id: 'fleet-console',
  ...
  },
  {
    ...
    media: {
      kind: 'loop',
      src: '/media/vision-control.webm',
      poster: '/media/vision-control.jpg',
      caption: '카메라로 인식한 파레트 위치에 맞춘 지게차 상차 동작',
    },
  },
]
