...
export function resolveVariant(keys, { param, storageKey, defaultKey }) {
  ...
  if (stored && keys.includes(stored)) return { variant: stored, source: 'stored' }
